...
exports.index = async (req, res) => {
  try {
    ...
    await sendError(error, req.body, 'LIST FEEDBACK', res);
  }
};
...
exports.get = async (req, res) => {
  try {
    ...
    await sendError(error, req.body, 'GET FEEDBACK', res);
  }
};
...
exports.new = async (req, res) => {
  try {
    ...
    await sendError(error, req.body, 'NOVO FEEDBACK', res);
  }
};
...
exports.delete = async (req, res) => {
  try {
    ...
    await sendError(error, req.body, 'REMOVE FEEDBACK', res);
  }
};
...
exports.edit = async (req, res) => {
  try {
    ...
    await sendError(error, req.body, 'EDITAR FEEDBACK', res);
  }
};
